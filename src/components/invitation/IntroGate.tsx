  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={finish}
        className="absolute right-5 bottom-6 z-10 rounded-full bg-[color-mix(in_oklab,var(--ivory)_70%,transparent)] px-4 py-2 font-sans text-[0.6rem] tracking-[0.28em] text-primary uppercase backdrop-blur transition hover:bg-white/90"
      >
        Skip
      </button>
    </motion.div>
