...
export const invitation = {
  ...
  productionUrl: "https://roshan-weds-indira.invitingyou.top",
  /** ISO date-time of the ceremony, used by the countdown and calendar file. */
  dateISO: "2027-01-28T16:00:00+05:30",
  dateLabel: "Thursday, 28 January 2027",
  timeLabel: "Ceremony 4:00 PM · Reception 6:00 PM",
  venue: {
    name: "St. Alphonsa’s Church",
    type: "Holy Matrimony Ceremony",
    address: "St. Alphonsa’s Church, Vasant Kunj",
    time: "4:00 PM",
    mapsQuery: "St. Alphonsa's Church Vasant Kunj New Delhi",
  ...
  rsvp: {
    title: "RSVP",
    note: "Kindly confirm your presence with us",
    contacts: [
      {
        name: "Roy C Paul & Anna Roy",
        phone: "9310803707",
        display: "+91 93108 03707",
        tel: "tel:+919310803707",
        whatsapp: "https://wa.me/919310803707?text=Heartiest%20congratulations%20on%20Roshan%20%26%20Indira%27s%20Wedding!",
      },
      {
        name: "Family & Loved Ones",
        phone: "9717801283",
        display: "+91 97178 01283",
        tel: "tel:+919717801283",
        whatsapp: "https://wa.me/919717801283?text=Heartiest%20congratulations%20on%20Roshan%20%26%20Indira%27s%20Wedding!",
      },
    ],
  },
  ...
  chapters: [
    ...
    },
    {
      ...
      text: "Solemn vows at St. Alphonsa’s Church, Vasant Kunj followed by an evening of dining and dancing under the chandeliers at Cherish Ballroom, Rubicon Glasshouse.",
    },
  ],
  footer: {
